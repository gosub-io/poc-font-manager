...
fn main() {
    ...
    render_table(FontSourceType::Fontkit, &manager, pattern);
    render_table(FontSourceType::Pango, &manager, pattern);
    render_table(FontSourceType::Fontique, &manager, pattern);
    render_table(FontSourceType::Parley, &manager, pattern);
}
